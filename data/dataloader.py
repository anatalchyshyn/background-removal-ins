...
class RGB_Dataset(Dataset):
    def __init__(self, root, sets, tfs):
        ...
        for set in sets:
            ...
            image_root, gt_root = os.path.join(root, set, 'raws'), os.path.join(root, set, 'masks')

            # image_root = '/home/jupyter/transparent/train/raws'
            # gt_root = '/home/jupyter/transparent/train/masks'
            # prior_root = '/home/jupyter/transparent/train/priors'
            
            #image_root = '/home/jupyter/temp/raws'
            #gt_root = '/home/jupyter/temp/masks'
            #prior_root = '/home/jupyter/temp/priors'

            images = [os.path.join(image_root, f) for f in os.listdir(image_root) if f.lower().endswith(('.jpg', '.jpeg', '.png'))]
            images = sort(images)
